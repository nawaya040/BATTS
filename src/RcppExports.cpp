...
RcppExport SEXP _BATTS_rotation_matrix(SEXP nSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _BATTS_evaluate_balance_weight_boosting(SEXP tree_listSEXP, SEXP eval_pointsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _BATTS_evaluate_balance_weight_BART(SEXP forest_listSEXP, SEXP eval_pointsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_BATTS_run_adaboost", (DL_FUNC) &_BATTS_run_adaboost, 25},
...
RcppExport void R_init_BATTS(DllInfo *dll) {
