...
Paper:
[Two-sample comparison through additive tree models for density ratios](https://arxiv.org/abs/2508.03059)

This README is organized as a short usage guide, following the same
README-as-vignette style used in the
[BIMA project](https://github.com/yuliangxu/BIMA).
...
The functions return the square root of the density ratio, so the example
below converts outputs to log-density ratios for plotting and
interpretation.

## Worked example

The full example script is included in
[`example.R`](example.R). The code below reproduces the main workflow.
